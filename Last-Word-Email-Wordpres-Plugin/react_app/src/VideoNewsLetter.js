...
class VideoNewsLetter extends Component {
  static propTypes = {
			...
			<tr>
            	<td>
	            	<table style={{textAlign: 'left',width:'750px',borderLeft:'1px solid #CCCCCC',borderRight:'1px solid #CCCCCC',borderTop:'1px solid #CCCCCC',margin:'0px auto'}} className="deviceWidth">
	            		<tr>
	            			<td style={{background:'#000',textAlign:'bottom',padding:'10px 9px 8px 9px'}}><a href="http://www.expertinvestoreurope.com/"><img src="https://pa.cms-lastwordmedia.com/wp-content/uploads/email-template-images/newsletter_logo1.jpg" style={{maxWidth: '100%'}} alt="Expert Investor"/></a></td>
						</tr>
			            	...
			            	<tr>
			                	<td>
			                        <table style={{textAlign: 'center',width:'100%', margin: '0px'}}>
				                    	<tr>
				                        	<td>
                                                                <table className="container" style={{width:'748px', textAlign: 'left'}}>
                                                                  <tr>
                                                                    <td style={{padding:'0px 10px 0px 9px',verticalAlign: 'top',margin:'0px'}}>
                                                                      <table style={this.props.highlight === 'articles' ? { animation : 'blink .5s step-end infinite alternate', border: '2px solid', width: '100%'} : {width: '100%'}}>
                                                                       <tr>
                                                                         <td style={{color:'#64a70b',fontSize: '22px',fontWeight: 'normal',borderBottom: '1px solid #e5eaee',padding: '10px 0px 3px 0px',fontFamily:'Georgia'}}><font style={{fontFamily:'Arial, Helvetica, sans-serif'}}>  Video </font></td>
                                                                       </tr>
                                                                      {this.props.articles.map((article,key) => {
                                                                        return article !== null ?  <tr key={key}>
                                                                        <td >
                                                                         <table width="100%" style={{borderBottom: '1px solid #e5eaee'}}>
                                                                          <tr>
                                                                           ...
                                                                           <td className="container_sub" style={{verticalAlign: 'top',padding:'13px 0px 14px', width: '68%', position: 'relative'}}>
                                                                            <table width="100%">
                                                                              <tr>
                                                                              ...
                                                                              <tr>
                                                                                <td style={{color: '#2c2c2c',fontSize: '14px',fontFamily: 'Arial, Helvetica, sans-serif',lineHeight: '20px'}}><font style={{fontFamily:'Arial, Helvetica, sans-serif'}} dangerouslySetInnerHTML={{__html:article.post_excerpt.substring(0,500)}}> 
                                                                                </font></td>
                                                                              </tr>
                                                                           </table>
                                                                          <i className="fa fa-times" onClick={this.props.onRemoveArticle} id={article.ID} style={{cursor:'pointer', color: '#BABABA',position:'absolute', right:'10px', top: '10px'}}></i>
                                                                        </td>
                                                                      </tr>
                                                                    </table>
                                                                  </td>
											...
											<tr>
                                                                                        {this.props.sponsoredContent.length > 0 && this.props.showSponsoredContent === '1' ? <td style={{padding:'18px 9px 18px 9px',position: 'relative'}}>
						...
						<td style={{padding:'3px 10px 3px 10px', background: '#d4d4d4', textAlign: 'left'}}><a className="more_from" href="http://www.international-adviser.com/" target="_blank" style={{color:'#000000',textDecoration: 'none',lineHeight: '14px',fontSize: '12px',fontFamily:  'Arial, Helvetica, sans-serif',fontWeight:'bold'}}><font style={{fontFamily:'Arial, Helvetica, sans-serif'}}>More Info</font></a></td>
				                           ...
				                           <tr>
												<td style={{padding:'0px 9px; 0px 9px'}}>
													<table width="728" className="device_innerblock" style={{width:'728px', textAlign: 'center'}}>
															<tr>
				                           ...
				                           <tr>
				                              <td style={{padding: '15px 15px 15px 15px', background: '#000'}} className="footer">
												<table className="footer_content" style={{textAlign: 'left', width: '100%'}}>
													<tr>
														<td style={{padding:'0px 0px 10px 0px', textAlign: 'left'}}>
				                                    ...
				                                    <tr>
				                                    	<td style={{padding:'0px 0px 5px 0px', textAlign: 'left'}}>
				                                    		<table style={{textAlign: 'left',margin: '0px', width:'265px'}} className="social_icon" width="265">
				                                    			<tr>
				                                    				...
				                                    				<td style={{textAlign: 'left'}}><a href="https://play.google.com/store/apps/details?id=com.lastwordmedia.eie" target="_blank"><img src="https://pa.cms-lastwordmedia.com/wp-content/uploads/email-template-images/googleplay.png" alt="img" style={{display:'block',maxWidth:'100%'}}/></a></td>
				                                    			</tr>
				                                    		</table>
				                                    	</td>
                                                                        </tr>
