        ...
        <div class="row">
          <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
            <div class="logo">
              ...
              ?>
              <a class="" href="<?php echo get_home_url(); ?>" title="<?php bloginfo('name'); ?>">
                <img src="<?php echo THEME_PATH.'/images/International-adviser-logo.svg' ?>" alt="" />
              </a>
              <?php
                  }
                } else {
            ...
            <div class="header-content">
              <div class="header-top clearfix">
                  ...
                  <ul>
                    ...
                    <li class="user-login-register">
                      <a href="<?php echo home_url();?>/register">
                        <img src="<?php echo THEME_PATH.'/images/svg/Register-icon-grey.svg' ?>" alt="" class="hidden"/>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31 31">
                          <style type="text/css">
                            .st0{fill:none;stroke:#1D1D1B;stroke-miterlimit:10;}
                            .st1{fill:#3C3C3B;}
                      ...
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <h2 class="modal-logo">INTERNATIONAL ADVISER</h2>
                            <h3 class="modal-title">SIGN IN</h3>
                          </div>
                          <div class="modal-body">
                            <p>Access full content on the International Adviser site, access your saved articles, control email preferences and amend your account details</p>
                ...
                <div class="social">
                  ...
                  <a target="_blank" href="https://www.linkedin.com/company/international-adviser">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31 31">
                      <style type="text/css">
                         .st0{fill:none;stroke:#1D1D1B;stroke-miterlimit:10;}
                      </style>
                  ...
                  <a target="_blank" href="https://twitter.com/IntAdviser">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31 31">
                      <style type="text/css">
                       .st0{fill:none;stroke:#1D1D1B;stroke-miterlimit:10;}
                       .st1{fill:#1D1D1B;}
