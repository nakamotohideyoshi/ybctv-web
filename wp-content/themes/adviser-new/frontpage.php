...
<section id="primary" class="content-area">
  <div id="content" class="site-content" role="main">
	...
	<div class="row">
	<div class="col-md-9" id="top-stories">
    ...
    </div><!--END OF TOP STORIES FIRST BLOCK-->   
    <div class="row other-latest">
		...
		<a href="<?php echo $current_permalink; ?>"><h3 class="story-title"><?php echo $current_title; ?></h3></a>
	                    ...
	                    <?php
                         ...
                         wp_reset_postdata();
                        ?>
    </div><!--END OF TOP STORIES LAST BLOCK-->
		<div class="row">
	...
	<h2 class="col-md-6 float-left">EVENTS</h2><p class="col-md-6 float-right">
	<button type="button" class="btn btn-calendar" data-toggle="modal" data-target="#exampleModal">
  view calendar
</button>
	</p>
	<!-- Modal -->
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="row modal-body">
		...
		<div post-template-cont>
		</div>
		<div class="target" style="display:none;"><h2 class="no-date">THERE IS NO ACTIVE EVENTS ON THIS DATE!</h2></div>
		</div>
	...
	<div class="col-md-12">
	<div class="native-content2">
	</div></div>
	</div>
    </div><!--END OF TOP STORIES COL-->
   ...
   <div class="empty-box1" id="addsblock-sidebar2">	
   </div>
	</div>
	
	</div>
	</div><!--END OF MOST POPULAR-->
	...
	</div><!--END OF LATEST, ANALYSIS, OPINION ROW SECTION-->
<div class="row">	
	<div class="col-md-9">
	<div class="row">
	<div class="col-md-12">
...
<span class="empty-box"></span>
	...
	</div><!--END OF MAGAZINES-EVENTS ROW-->
	</div><!--END OF CONTENT-->	
</div>
</section>
<?php
