...
<head>
  ...
  <link rel="icon" href="<?php echo THEME_PATH.'/images/favicon/FSA_16x16.ico' ?>" sizes="16x16">
  <link rel="icon" href="<?php echo THEME_PATH.'/images/favicon/FSA_32x32.ico' ?>" sizes="32x32">
  <link rel="icon" href="<?php echo THEME_PATH.'/images/favicon/FSA_152x152.png' ?>" sizes="152x152">
        ...
        <div class="row">
          <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
            <div class="logo">
              ...
              ?>
              <a class="" href="<?php echo get_home_url(); ?>" title="<?php bloginfo('name'); ?>">
                <img src="<?php echo THEME_PATH.'/images/Fund-Selector-Asia-logo.svg' ?>" alt="" />
              </a>
              <?php
                  }
                } else {
                      ...
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <h2 class="modal-logo">FUND SELECTOR ASIA</h2>
                            <h3 class="modal-title">SIGN IN</h3>
                          </div>
                          <div class="modal-body">
                            <p>Access full content on the Fund Selector Asia site, access your saved articles, control email preferences and amend your account details</p>
