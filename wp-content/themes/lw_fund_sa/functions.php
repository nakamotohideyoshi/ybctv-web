...
h1 a {width: 170px !important;background-size: contain !important;background-image: url('.get_bloginfo('template_directory').'/images/Fund-Selector-Asia-logo.svg) !important; }
</style>';
}
...
function add_featured_box_settings_page() {
  $posts = get_posts( array( 'posts_per_page' => 100, 'category' => 14 ) );
