          ...
          <div class="list-content-page">
            ...
            <div class="list-event">
                ...
                if (have_posts()) : while (have_posts()) : the_post();
                  ...
                  $link = get_post_meta($post->ID,'lw_event_link', TRUE);
                  $target = get_post_meta($post->ID,'lw_event_target_blank', TRUE);
                  $target = $target == 'yes' ? ' target="_blank"' : '';
  						?>
              <div class="loop-list">
                <div class="row">
                  <div class="col-md-8 col-sm-12 col-xs-12">
                    <div class="content-image">
                      ...
                      ?>
                      <a<?php echo $target; ?> href="<?php echo $link; ?>"><img src="<?php echo THEME_PATH.'/images/not-image.jpg' ?>" alt="<?php echo mb_strimwidth( get_the_title(), 0, 50, '...' ); ?>" /></a>
                      <?php
                        }
                      ?>
                    </div>
                  ...
                  <div class="col-md-4 col-sm-12 col-xs-12">
                    <div class="content-des">
                      <a<?php echo $target; ?> href="<?php echo $link; ?>"><h3><?php echo get_the_title(); ?></h3></a>
                      <p class="date">
                        <?php
