...
render() {
  ...
  <div style={{ ...style, border, borderStyle, overflow, animation }}>
      <table style={{width: '100%', border: '0px', margin: '0px', textAlign: 'center',borderCollapse: 'collapse',tableLayout: 'fixed',msoTableLspace:'0pt', msoTableRspace:'0pt', borderSpacing:'0px'}}>
                <tr>
                                <td>
                                        <table className="deviceWidth" style={{margin:'0px auto', width: '750px', textAlign: 'center', border: '0px', margin: '0px'}}>
                                                <tr>
                                                        <td>
                                                                <table style={{textAlign: 'center', width: '100%', margin: '0px'}} className="email_send">
                                                                        <tr>
                                                                                ...
                                                                                <td width="398" style={{width: '398px',padding:'8px 10px 8px 10px',fontFamily: 'Arial, Helvetica, sans-serif',fontSize: '11px',color: '#2D2C28', textAlign: 'left'}}>If you are unable to view this email, <a style={{color:'#000',textDecoration:'none'}} href="[*link.webversion_url*]">click here</a></td>
                                                                        </tr>
                                                                </table>
                                                        </td>
                                                </tr>
                ...
                <td>
                        <table style={{width: '750px', textAlign: 'left', borderLeft:'1px solid #CCCCCC',borderRight:'1px solid #CCCCCC',borderTop:'1px solid #CCCCCC',margin:'0px auto'}} className="deviceWidth">
                                ...
                                <table className="deviceWidth" style={{borderLeft:'1px solid #CCCCCC',borderRight:'1px solid #CCCCCC',margin:'0px auto', background: '#fff', width: '750px', textAlign: 'center'}}>
                                        <tr>
                                                <td>
                                                <table style={{textAlign: 'center', width: '100%', margin: '0px'}}>
                                                        <tr>
                                                                <td>
                                                                        <table className="container" style={{textAlign: 'left', width: '748px'}}>
        <tr>
                ...
                <table style={this.props.highlight === 'articles' ? { animation : 'blink .5s step-end infinite alternate', border: '2px solid', width: '100%'} : {width: '100%'}}>
                        <tr>
                                <td style={{color:'#64a70b',fontSize: '22px',fontWeight: 'normal',borderBottom: '1px solid #e5eaee',padding: '10px 0px 3px 0px',fontFamily:'Georgia'}}><font style={{fontFamily:'Georgia'}}>Breaking News</font></td>
                        </tr>
                        ...
                        {this.props.articles.map((article,key) => {
                         ...
                         <td >
                          <table style={{borderBottom: '1px solid #e5eaee', width: '100%', position: 'relative'}}>
                           <tr>
                             <td className="container_sub" style={{padding:'20px 10px 14px 0px',verticalAlign: 'top', width: '32%'}}> 
                              <a href="http://www.expertinvestoreurope.com/gallery/1033310/asset-classes-lost-investors-money-2016">
                            ...
                            <td className="container_sub" style={{verticalAlign: 'top',padding:'13px 0px 14px', width: '68%'}}>
                             <table width="100%">
                               <tr>
                                 <td style={{padding: '0px 0px 7px'}}> <a href="http://www.expertinvestoreurope.com/gallery/1033310/asset-classes-lost-investors-money-2016" style={{fontSize: '14px',fontFamily: 'Arial, Helvetica, sans-serif',textDecoration: 'none', color: '#63a70a'}} title="Which asset classes lost you most money in 2016?"><font style={{fontFamily:'Arial, Helvetica, sans-serif'}}>{article.post_title}</font></a> </td>
                               </tr>
                               <tr>
                                                ...
                                                <td style={{padding:'3px 10px 3px 10px', textAlign: 'left', background: '#d4d4d4'}}><a className="more_from" href="http://www.international-adviser.com/" target="_blank" style={{color:'#000000',textDecoration: 'none',lineHeight: '14px',fontSize: '12px',fontFamily:'Arial, Helvetica, sans-serif',fontWeight:'bold'}}><font style={{fontFamily: 'Arial, Helvetica, sans-serif'}}>More Info</font></a></td>
                                                           ...
                                                           <tr>
                                                                                                <td style={{padding:'0px 9px; 0px 9px'}}>
                                                                                                        <table style={{textAlign: 'center', width: '728px'}} className="device_innerblock">
                                                                                                                        <tr>
                                                           ...
                                                           <tr>
                                                              <td style={{padding: '15px 15px 15px 15px', background: '#000'}} className="footer">
                                                                                                <table  style={{width:'100%', textAlign: 'left'}} className="footer_content">
                                                                                                        <tr>
                                                                                                                <td style={{padding:'0px 0px 10px 0px', textAlign: 'left'}}>
                                                                                                                        <table style={{margin: '0px', width: '140px', textAlign: 'left'}} className="social_icon">
                                                                                                                                <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td style={{padding:'0px 0px 5px 0px', textAlign: 'left'}}>
                                                                                <table style={{margin: '0px', textAlign: 'left', width: '265px'}} className="social_icon">
                                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                                <td>
                                                                                        <table style={{width: '100%'}}>
                                                                                                <tr>
                                                                                                        <td className="footer_left" style={{padding:'0px 20px 0px 0px', width: '80%', textAlign: 'left'}}>
                                                                                                                <table style={{width: '100%'}}>
                                                                                                                        <tr>
                                                                                                        ...
                                                                                                        <td className="footer_left" style={{textAlign: 'right', width: '20%'}}><a href="http://www.lastwordmedia.com" target="_blank"><img src="https://pa.cms-lastwordmedia.com/wp-content/uploads/email-template-images/newsletter_lastword1.png" alt="logo" style={{maxWidth: '100%',display:'block'}} /></a></td>
                                                                                                         </tr>
                                                                                                </table>
                                                                                        </td>
                                                                                        </tr>
