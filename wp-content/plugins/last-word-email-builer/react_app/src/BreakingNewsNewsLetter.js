      ...
      <table style={{width: '100%', border: '0px', margin: '0px', textAlign: 'center',borderCollapse: 'collapse',tableLayout: 'fixed',msoTableLspace:'0pt', msoTableRspace:'0pt', borderSpacing:'0px'}}>
        ...
        <tr>
                ...
                <table style={this.props.highlight === 'articles' ? { animation : 'blink .5s step-end infinite alternate', border: '2px solid', width: '100%'} : {width: '100%'}}>
                        <tr>
                                <td style={{color,fontSize: '22px',fontWeight: 'normal',borderBottom: '1px solid #e5eaee',padding: '10px 0px 3px 0px',fontFamily:'Georgia'}}><font style={{fontFamily:'Georgia'}}>Breaking News</font></td>
                        </tr>
                          ...
                          <table style={{borderBottom: '1px solid #e5eaee', width: '100%', position: 'relative'}}>
                           <tr>
                            ...
                            <td className="container_sub" style={{verticalAlign: 'top',padding:'13px 0px 14px', width: '68%'}}>
                             <table width="100%">
                               <tr>
                                 <td style={{padding: '0px 0px 7px'}}> <a href={article.guid} style={{fontSize: '14px',fontFamily: 'Arial, Helvetica, sans-serif',textDecoration: 'none', color}} title="Which asset classes lost you most money in 2016?"><font style={{fontFamily:'Arial, Helvetica, sans-serif'}}>{article.post_title}</font></a> </td>
                               </tr>
                               <tr>
