...
onRemoveEditor = (event) => {
 console.log(event.target.id);
 this.props.onRemoveEditor(event.target.id);
}
render() {
...
<tr>
	...
	<table style={this.props.highlight === 'articles' ? { animation : 'blink .5s step-end infinite alternate', border: '2px solid', width: '100%'} : {width: '100%'}}>
		<tbody><tr>
			<td style={{color:'#64a70b',fontSize: '22px',fontWeight: 'normal',borderBottom: '1px solid #e5eaee',padding: '10px 0px 3px 0px',fontFamily:'Georgia'}}>
			...
			<table style={{borderBottom: '1px solid #e5eaee', width: '100%', position: 'relative'}}>
				<tbody><tr>
									...
									<td className="container_sub" style={{verticalAlign: 'top',padding:'13px 0px 14px'}}>						
										<table width="100%">
												<tbody><tr>
													<td style={{padding: '0px 0px 7px'}}> <a href="http://www.expertinvestoreurope.com/features/1037293/analysis-sailing-macro-winds-japanese-equities" style={{fontSize: '14px',fontFamily:'Arial, Helvetica, sans-serif',textDecoration: 'none', color: '#63a70a'}} title="ANALYSIS: Sailing the macro winds in Japanese equities"><font style={{fontFamily:'Arial, Helvetica, sans-serif'}}>{article.post_title}</font></a> </td>
												</tr>
												<tr>
...
{ this.props.newsletterSubscribe.length > 0 && this.props.showNewsletterSubscribe === '1' ? <tr>
  <td className="ql-editor" style={{position: 'relative', padding: '0px', margin: '0px', background: '#fff'}}>
   ...
   <i className="fa fa-times" onClick={this.props.onRemoveStatic} id='Newsletter_Subscribe' style={{cursor:'pointer', color: '#BABABA',position:'absolute', right:'10px', top: '10px'}}></i>
  </td>
</tr> : ''}
</tbody>
</table>
				...
				<tbody>
						<tr>
							<td style={{padding:'7px 0px 7px', position: 'relative'}}>
								<a href="http://lastwordmedia.eventscase.com/EN/PAAlternatives17" style={{color:'#64a70b',fontSize: '14px',fontFamily:'Arial, Helvetica, sans-serif',textDecoration: 'none'}}><font>{article.post_title}</font></a>
                                                                <i className="fa fa-times" onClick={this.onRemoveEvent} id={article.ID} style={{cursor:'pointer', color: '#BABABA',position:'absolute', right:'0px', top: '10px'}}></i> 
							</td>
						</tr>
			          <tr>
...
<tr>
	<td>
		<table style={this.props.highlight === 'editor' ? {animation : 'blink .5s step-end infinite alternate', border: '2px solid', width: '100%'} : {width: '100%'}}>
				<tbody><tr>
					<td style={{color: '#64a70b',fontSize: '22px',fontWeight: 'normal',borderBottom: '1px solid #e5eaee',padding:'20px 0px 3px 0px',fontFamily:'Georgia'}}>
								...
								<table style={{width: '100%', textAlign: 'left', position: 'relative'}}>
											<tbody><tr>
												<td style={{padding: '12px 0px 12px 0px',borderBottom: '1px solid #e5eaee'}}>
													<a href="http://www.portfolio-adviser.com/news/1037528/standard-life-aberdeen-confirm-creation-gbp11bn-investment-giant" style={{color:'#64a70b',fontSize: '14px',fontFamily:'Arial, Helvetica, sans-serif',textDecoration: 'none'}} title={article.post_title}><font>{article.post_title}</font></a> 
                                                                                                        <i className="fa fa-times" onClick={this.onRemoveEditor} id={article.ID} style={{cursor:'pointer', color: '#BABABA',position:'absolute', right:'0px', top: '10px'}}></i> 
												</td>
											</tr>
								</tbody></table>
							</td>
