...
{this.props.sponsoredContent2.length > 0 && this.props.showSponsoredContent2 === '1' ? <td style={{background: '#dadada', position: 'relative', left:'10px', bottom:'4px'}}>
        <div dangerouslySetInnerHTML={{__html:this.props.sponsoredContent2}}></div>
