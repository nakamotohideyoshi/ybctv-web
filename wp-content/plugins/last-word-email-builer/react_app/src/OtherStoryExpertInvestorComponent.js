...
class OtherStoryExpertInvestorComponent extends Component {
  state = { 
  };

  render() {
    return (
      <div className="section_content component_block" style={{float:'left',display: 'inline'}} id="component_dda127db-bd7e-4399-8c75-1500c688370a" align="left">
...
<tr>
      <td style={{padding: '0px 0px 10px 0px', textAlign: 'left'}} data-align="left">
              <a href="http://www.expertinvestoreurope.com/" target="_blank"><img alt="Expert Investor" src="https://pa.cms-lastwordmedia.com/wp-content/uploads/email-template-images/eie_newsletter.jpg" title="Expert Investor"/></a>
      </td>
</tr>
{this.props.selectedStoryArticles.wp_5_.articles.map((article, key) => {
return <tr>
...
<tr>
      ...
      <table className="more" style={{width:'75px', textAlign: 'left'}} data-align="left" data-width="75">
              <tr>
                      <td style={{padding:'3px 10px 3px 10px',background:'#d4d4d4',textAlign:'left'}} data-width="70"><a className="more_from" href="http://www.expertinvestoreurope.com/" target="_blank" style={{color:'#000000',textDecoration: 'none',lineHeight: '14px',fontSize: '12px',fontFamily:  'Arial, Helvetica, sans-serif',fontWeight:'bold'}}><font style={{fontFamily:'Arial, Helvetica, sans-serif'}}>More Info</font></a></td>
              </tr>
      </table></td>
</tr>
</table></td>
...
export default OtherStoryExpertInvestorComponent;
