...
class InsightsNewsLetter extends Component {
static propTypes = {
...
{ this.props.site !== 'wp_5_' ? <tr>
<td style={{color,fontSize: '22px',fontWeight: 'normal',borderBottom: '1px solid #e5eaee',padding: '10px 0px 3px 0px',fontFamily:'Georgia'}}><font style={{fontFamily:'Georgia'}}>Insights</font></td>
</tr>: ''}
