...
const boxTarget = {
  drop(props, monitor, component) {
    ...
    props.onArticleDropped(item.id,'Most_Read');
    return { name: props.email };
  },
};

class MostReadComponent extends Component {
static propTypes = {
...
render() {
  ...
  <table data-width="100%" style={this.props.highlight === 'rated' ? { animation : 'twinkle .5s step-end infinite alternate', border: '2px solid', width: '100%'} : {width: '100%'}}>
          <tbody><tr>
                  ...
                  <font style={{fontFamily:'Georgia'}}> Most read </font>
                  </td>
          </tr>
