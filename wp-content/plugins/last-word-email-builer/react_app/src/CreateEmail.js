 ...
 <div className="panel panel-default">
    ...
    <div id="collapseTwo" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
      <div className="panel-body">
            ...
            <DragStatic id="button4" name="Sponsored_Content" text="Sponsored Content" onStaticDragged={this.props.onStaticDragged} onCancelStaticDrag={this.props.onCancelStaticDrag} onStaticDropped={this.onStaticDropped} onClick={() => this.onSetTemplate('Sponsored_Content')} isDisabled={this.props.hasSponsoredContent === "0" ? true : false}/>
            <DragStatic id="button5" name="Sponsored_Content_2" text="Sponsored Content 2" onStaticDragged={this.props.onStaticDragged} onCancelStaticDrag={this.props.onCancelStaticDrag} onStaticDropped={this.onStaticDropped} onClick={() => this.onSetTemplate('Sponsored_Content_2')} isDisabled={this.props.hasSponsoredContent2 === "0" ? true : false}/>
            <DragStatic id="button6" name="Top_Leaderboard" text="Top Leaderboard" onStaticDragged={this.props.onStaticDragged} onCancelStaticDrag={this.props.onCancelStaticDrag} onStaticDropped={this.onStaticDropped} onClick={() => this.onSetTemplate('Top_Leaderboard')} isDisabled={this.props.hasTopLeaderboard === "0" ? true : false}/>
            <DragStatic id="button7" name="Footer_Leaderboard" text="Footer Leaderboard" onStaticDragged={this.props.onStaticDragged} onCancelStaticDrag={this.props.onCancelStaticDrag} onStaticDropped={this.onStaticDropped} onClick={() => this.onSetTemplate('Footer_Leaderboard')} isDisabled={this.props.hasFooterLeaderboard === "0" ? true : false}/>
            <DragStatic id="button8" name="Static_Image_1" text="Static Image 1" onStaticDragged={this.props.onStaticDragged} onCancelStaticDrag={this.props.onCancelStaticDrag} onStaticDropped={this.onStaticDropped} onClick={() => this.onSetTemplate('Static_Image_1')} isDisabled={this.props.hasStaticImage1 === "0" ? true : false}/>
            <DragStatic id="button9" name="Static_Image_2" text="Static Image 2" onStaticDragged={this.props.onStaticDragged} onCancelStaticDrag={this.props.onCancelStaticDrag} onStaticDropped={this.onStaticDropped} onClick={() => this.onSetTemplate('Static_Image_2')} isDisabled={this.props.hasStaticImage2 === "0" ? true : false}/>
            <DragStatic id="button10" name="Asset_Class" text="Asset Class" onStaticDragged={this.props.onStaticDragged} onCancelStaticDrag={this.props.onCancelStaticDrag} onStaticDropped={this.onStaticDropped} onClick={() => this.onSetTemplate('Asset_Class')} isDisabled={this.props.hasAssetClass === "0" ? true : false}/>
            <DragStatic id="button11" name="Quotable" text="Quotable" onStaticDragged={this.props.onStaticDragged} onCancelStaticDrag={this.props.onCancelStaticDrag} onStaticDropped={this.onStaticDropped} onClick={() => this.onSetTemplate('Quotable')} isDisabled={this.props.hasQuotable === "0" ? true : false}/>
      </div>
    </div>
   </div>
      <div className="panel panel-default">
