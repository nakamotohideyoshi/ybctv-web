    ...
    <div id="collapseTwo" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
      <div className="panel-body">
          <div className="row">
            ...
            { this.props.site == 'wp_4_' ? <DragStatic id="button35" name="Static_Image_2d" text="Static Image 2D" onShowPreviewBox={this.onShowPreviewBox} onHidePreviewBox={this.onHidePreviewBox} onStaticDragged={this.props.onStaticDragged} onCancelStaticDrag={this.props.onCancelStaticDrag} onStaticDropped={this.onStaticDropped} onClick={() => this.onSetTemplate('Static_Image_2d')} isDisabled={this.props.hasStaticImage2 === "0" ? true : true}/> : null }
