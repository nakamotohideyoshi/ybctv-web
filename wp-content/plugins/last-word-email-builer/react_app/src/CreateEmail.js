    ...
    <div id="collapseTwo" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
      <div className="panel-body">
          <div className="row">
            ...
            <DragStatic id="button2" name="Digital_Magazine" text="Digital Magazine" onStaticDragged={this.props.onStaticDragged} onCancelStaticDrag={this.props.onCancelStaticDrag} onStaticDropped={this.onStaticDropped} onClick={() => this.onSetTemplate('Digital_Magazine')} isDisabled={this.props.hasDigitalMagazine === "0" ? true : false}/>
            <DragStatic id="button3" name="Digital_Magazine_2" text="Digital Magazine 2" onStaticDragged={this.props.onStaticDragged} onCancelStaticDrag={this.props.onCancelStaticDrag} onStaticDropped={this.onStaticDropped} onClick={() => this.onSetTemplate('Digital_Magazine_2')} isDisabled={this.props.hasDigitalMagazine === "0" ? true : false}/>
