...
class DigitalMagazineNewsLetter extends Component {
static propTypes = {
      ...
      <table data-width="100%" data-border="0" cellPadding="0" cellSpacing="0" data-align="center" style={{width: '100%', border: '0px', margin: '0px', textAlign: 'center',borderCollapse: 'collapse',tableLayout: 'fixed',msoTableLspace:'0pt', msoTableRspace:'0pt', borderSpacing:'0px'}}>
                                                ...
                                                <tr>
                                                        <td>
                                                                <table data-align="center" data-width="100%"  cellSpacing="0" cellPadding="0" style={{textAlign: 'center', width: '100%', margin: '0px'}} className="email_send">
                                                                        <tr>
                                                                                {this.props.site === 'wp_2_' ? <td data-align="left" data-width="280" style={{width:'280px',padding:'8px 10px 8px 10px',fontFamily: 'Arial, Helvetica, sans-serif',fontSize: '11px', textAlign: 'left'}}><a href="http://www.portfolio-adviser.com/" style={{color:'#000000',textDecoration:'none'}}>Portfolio Adviser Magazine</a></td>: ''}
                                                                                {this.props.site === 'wp_3_' ? <td data-align="left" data-width="280" style={{width:'280px',padding:'8px 10px 8px 10px',fontFamily: 'Arial, Helvetica, sans-serif',fontSize: '11px', textAlign: 'left'}}><a href="http://www.international-adviser.com/" style={{color:'#000000',textDecoration:'none'}}>International Adviser Magazine</a></td>: ''}
                                                                                {this.props.site === 'wp_4_' ? <td data-align="left" data-width="280" style={{width:'280px',padding:'8px 10px 8px 10px',fontFamily: 'Arial, Helvetica, sans-serif',fontSize: '11px', textAlign: 'left'}}><a href="http://www.fundselectorasia.com/" style={{color:'#000000',textDecoration:'none'}}>Fund Selector Asia Magazine</a></td>: ''}
                                                                                {this.props.site === 'wp_5_' ? <td data-align="left" data-width="280" style={{width:'280px',padding:'8px 10px 8px 10px',fontFamily: 'Arial, Helvetica, sans-serif',fontSize: '11px', textAlign: 'left'}}><a href="http://www.expertinvestoreurope.com/" style={{color:'#000000',textDecoration:'none'}}>Expert Investor Magazine</a></td>: ''}
                ...
                <td data-valign="top">
                        <table data-width="750" cellSpacing="0" cellPadding="0" data-align="center"  style={{width: '750px', textAlign: 'left', borderLeft:'1px solid #CCCCCC',borderRight:'1px solid #CCCCCC',borderTop:'1px solid #CCCCCC',margin:'0px auto'}} className="deviceWidth">
                                <tr>
                                        <td style={{padding:'10px 9px 8px 9px', background: '#000'}} bgcolor="#000000" data-align="bottom">
                                        ...
                                        {this.props.site === 'wp_5_' ? <a href="http://www.expertinvestoreurope.com/"><img src="http://assets.kreatio.net/expert_investor_europe/images/newsletter_logo.png" style={{maxWidth: '100%'}} alt="Expert Investor"/></a> :''}
                                                        ...
                                                        <tr>
                                                                <td data-bgcolor="#ffffff" data-align="center" style={{verticalAlign: 'bottom',padding:'10px 0px 0px 0px', background: '#fff', textAlign: 'center'}}></td>
                                                        </tr>
        ...
        <tr>
                ...
                <table style={{width: '100%'}} data-width="100%">
                        ...
                        <tr>
                        {this.props.staticHighlight === 'digitalMagazine' ? <td style={{ animation : 'twinkle .5s step-end infinite alternate', border: '2px solid'}}><div><br/></div></td> : ''}
                        { this.props.digitalMagazine.length > 0 ? <td style={{background: '#fff', position: 'relative', color}}>
                                <div dangerouslySetInnerHTML={{__html:this.props.digitalMagazine}}></div>
                                <img src="https://pa.cms-lastwordmedia.com//wp-content/plugins/email-builder/cross.png" className="cross-img" style={{width:'10px',cursor:'pointer',position: 'absolute',right:'10px',top:'10px'}} id="Digital_Magazine" onClick={this.props.onRemoveStatic}/>
                                </td> : ''}
                        </tr>
                </table>
                </td>
        ...
        <table style={{width: '728px', textAlign: 'center'}} data-width="728" data-align="center" className="device_innerblock">
                <tr>
                                                              ...
                                                              <td style={{padding: '15px 15px 15px 15px', background: '#000'}} className="footer" data-bgcolor="#000000">
                                                                        ...
                                                                        <tr>
                                                                                <td>
                                                                                        <table style={{width: '100%'}} data-width="100%">
                                                                                                <tr>
                                                                                                        <td className="footer_left" style={{padding:'0px 20px 0px 0px', width: '80%', textAlign: 'left'}} data-valign="bottom" data-align="left" data-width="80%">
                                                                                                                <table style={{width: '100%'}}  data-width="100%">
                                                                                                                        <tr>
