...
class VideoNewsLetter extends Component {
  ...
  render() {
         	...
         	<tr>
				<td>
					<table className="deviceWidth" style={{margin:'0px auto',width:'750px',textAlign:'center'}} cellSpacing="0" cellPadding="0" data-border="0" data-align="center" data-width="750">
						<tr>
							<td>
								<table data-align="center" data-width="100%"  cellSpacing="0" cellPadding="0"  style={{textAlign: 'left', width: '100%', margin: '0px'}} className="email_send">
									<tr>
                                                                                {this.props.site === 'wp_2_' ? <td data-align="left" data-width="280" style={{width:'280px',padding:'8px 10px 8px 10px',fontFamily: 'Arial, Helvetica, sans-serif',fontSize: '11px', textAlign: 'left'}}><a href="http://www.portfolio-adviser.com/" style={{color:'#000000',textDecoration:'none'}}>Portfolio Adviser Video</a></td>: ''}
                                                                                {this.props.site === 'wp_3_' ? <td data-align="left" data-width="280" style={{width:'280px',padding:'8px 10px 8px 10px',fontFamily: 'Arial, Helvetica, sans-serif',fontSize: '11px', textAlign: 'left'}}><a href="http://www.international-adviser.com/" style={{color:'#000000',textDecoration:'none'}}>International Adviser Video</a></td>: ''}
                                                                                {this.props.site === 'wp_4_' ? <td data-align="left" data-width="280" style={{width:'280px',padding:'8px 10px 8px 10px',fontFamily: 'Arial, Helvetica, sans-serif',fontSize: '11px', textAlign: 'left'}}><a href="http://www.fundselectorasia.com/" style={{color:'#000000',textDecoration:'none'}}>Fund Selector Asia Video</a></td>: ''}
                                                                                {this.props.site === 'wp_5_' ? <td data-align="left" data-width="280" style={{width:'280px',padding:'8px 10px 8px 10px',fontFamily: 'Arial, Helvetica, sans-serif',fontSize: '11px', textAlign: 'left'}}><a href="http://www.expertinvestoreurope.com/" style={{color:'#000000',textDecoration:'none'}}>Expert Investor Video</a></td>: ''}
            	...
            	<td data-valign="top">
	            	<table data-width="750" cellSpacing="0" cellPadding="0" data-align="center" style={{textAlign: 'left',width:'750px',borderLeft:'1px solid #CCCCCC',borderRight:'1px solid #CCCCCC',borderTop:'1px solid #CCCCCC',margin:'0px auto'}} className="deviceWidth">
		                ...
		                <table className="deviceWidth" data-width="750" cellSpacing="0" cellPadding="0" data-bgcolor="#ffffff" data-align="center" style={{background:'#fff', width:'750px',borderLeft:'1px solid #CCCCCC',borderRight:'1px solid #CCCCCC',margin:'0px auto'}}>
			            	<tr>
			                	<td>
			                        <table data-align="center" data-width="100%" cellSpacing="0" cellPadding="0" style={{width:'100%', margin: '0px'}}>
				                    	<tr>
				                        	<td>
	...
	<table data-width="728" data-align="center" className="device_innerblock" style={{width:'728px', textAlign:'center'}}>
		<tr>
                                     ...
                                     <td style={{padding:'0px 9px; 0px 9px'}}>
				                           ...
				                           <tr>
				                              <td style={{padding: '15px 15px 15px 15px', background: '#000'}} className="footer" data-bgcolor="#000000">
												<table className="footer_content" style={{textAlign: 'left', width: '100%'}} data-width="100%" data-align="left">
                                                                                                <tr>
