                                                                  ...
                                                                  <tr>
                                                                    <td style={{padding:'0px 10px 0px 9px',verticalAlign: 'top',margin:'0px'}}>
                                                                      <table style={this.props.highlight === 'articles' ? { animation : 'blink .5s step-end infinite alternate', border: '2px solid', width: '100%'} : {width: '100%'}}>
                                                                       <tr>
                                                                         <td style={{color,fontSize: '22px',fontWeight: 'normal',borderBottom: '1px solid #e5eaee',padding: '10px 0px 3px 0px',fontFamily:'Georgia'}}><font style={{fontFamily:'Arial, Helvetica, sans-serif'}}>  Video </font></td>
                                                                       </tr>
